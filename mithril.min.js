...
""===m&&""!==l?p=l:"#"===m?w.id=l:"."===m?k.push(l):"["===h[3][0]&&((m=h[6])&&(m=m.replace(/\\(["'])/g,"$1").replace(/\\\\/g,"\\")),"class"===h[4]?k.push(m):w[h[4]]=m||!0)}0<k.length&&(w.className=k.join(" "));h=N[a]={tag:p,attrs:w}}}if(arguments.length===e+1)M(arguments[e])&&arguments[e].startsWith(".")?d.className=arguments[e].substring(1).split(".").join(" "):"object"!==typeof arguments[e]||Array.isArray(arguments[e])?f=arguments[e]:d=Object.assign(d,arguments[e]),Array.isArray(f)||(f=[f]);else for(f=
[];e<arguments.length;)M(arguments[e])&&arguments[e].startsWith(".")?d.className=arguments[e].substring(1).split(".").join(" "):"object"!==typeof arguments[e]||Array.isArray(arguments[e])?f.push(arguments[e]):d=Object.assign(d,arguments[e]),e++;e=B.normalizeChildren(f);if("string"===typeof a){f=h;h=!1;var u,b,p=d.className||d["class"],q;for(q in f.attrs)O.call(f.attrs,q)&&(d[q]=f.attrs[q]);void 0!==p&&(void 0!==d["class"]&&(d["class"]=void 0,d.className=p),null!=f.attrs.className&&(d.className=f.attrs.className+
